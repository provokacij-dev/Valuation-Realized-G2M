...
interface UploadQueueProps {
  /** When embedded under another heading, render as h2 instead of h1 and tone down the title color */
  embedded?: boolean;
}

export default function UploadQueue({ embedded = false }: UploadQueueProps) {
  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
        <div>
          <TitleTag className={titleClass}>Upload Queue</TitleTag>
      ...
      {ads.length === 0 && (
        <div className="flex flex-col items-center justify-center py-16 text-gray-400">
          ...
          <p className="text-sm mt-1">
            Approve ads above to add them here.
          </p>
        </div>
      )}
